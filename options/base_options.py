...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='mffanet', help='chooses which model to train [parse|enhance]')
        parser.add_argument('--att_name', type=str, default='mffa3d', help='attention type [mffa3d]')
